...
Esta classe e referente ao user que pode criar alugueres, contendo
...
Esta classe contem a informacao de todos os utilizadores do sistema.
...
como procurar carros conforme as condicoes dadas para efetuar um aluguer.

\subsection{Rental}

Esta classe contem todos os metodos para gerar e tratar um aluguer
\section{View}
...
Esta Package contém todas as classes de excepções utilizadas ao longo do projeto.
